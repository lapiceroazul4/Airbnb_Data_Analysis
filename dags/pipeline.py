...
import logging
import json
from api_yf_transform import read_Data,cambiar_a_columna_date, borrar_columns 
from airbnb.Database import database_connection,insert_Data_to_Database, read_Data_From_Database
from transform import standarizanding_Columns,drop_Duplicates,delete_Unnecesary_Columns,standarizanding_Names,delete_Special_Caracthers,fill_nulls,last_standarization,borrar_todos
...
def load_api():
    ...
    df=transform_Yahoo_Finance_Api(df)
    print(df)
